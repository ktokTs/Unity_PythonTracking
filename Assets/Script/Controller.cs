...
public class Controller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.J))
            TraceParticleScript.SetLinearTrans(HandsPoints, 0);
        if (Input.GetKeyDown(KeyCode.H))
            TraceParticleScript.SetLinearTrans(HandsPoints, 1);
        if (Input.GetKeyDown(KeyCode.N))
            TraceParticleScript.SetLinearTrans(HandsPoints, 2);
        if (Input.GetKeyDown(KeyCode.M))
            TraceParticleScript.SetLinearTrans(HandsPoints, 3);
        if (Input.GetKeyDown(KeyCode.K))
            TraceParticleScript.SetLinearTrans(HandsPoints, 5);
    }
